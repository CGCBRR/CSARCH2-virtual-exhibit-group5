...
import { SimulatorControls } from '../components/cache/simulator-controls'
import { ExhibitNotes } from '../components/cache/exhibit-notes'
import { Visualizer, type SimState } from '../components/cache/visualizer'
import {
  createEmptyCache,
  lookup,
  parseAddress,
...
export default function Page() {
  ...
  return (
    <main className="min-h-dvh bg-slate-950 text-slate-100 selection:bg-cyan-500/30">
